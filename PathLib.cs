...
public class PupokPathWrapper(string path) {
  ...
  public PupokPathWrapper parent()                                     => new(PathLib.parent(value));
  public PupokPathWrapper normalized()                                 => new(PathLib.normalize(value));
  public PupokPathWrapper join(PupokPathWrapper a)                     => new(PathLib.join(value, a.value));
  public PupokPathWrapper join(PupokPathWrapper a, PupokPathWrapper b) => new(PathLib.join(value, a.value, b.value));
